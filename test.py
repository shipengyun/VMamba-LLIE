...
parser.add_argument('-opt', type=str,default=r'options/test/LOLv2_synthetic.yml' ,help='Path to options YMAL file.')
...
def main():
    ...
    save_folder = 'SNR-Low-Light-Enhance/results/{}'.format(opt['name'])
